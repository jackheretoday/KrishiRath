  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-bold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        saffron: "saffron-gradient text-accent-foreground shadow-md hover:shadow-lg hover:brightness-110",
        hero: "bg-primary text-primary-foreground shadow-xl hover:shadow-2xl text-lg",
        "hero-outline": "border-2 border-primary-foreground/80 bg-transparent text-primary-foreground hover:bg-primary-foreground/10 text-lg",
        call: "bg-accent text-accent-foreground shadow-md hover:shadow-lg",
      },
      size: {
